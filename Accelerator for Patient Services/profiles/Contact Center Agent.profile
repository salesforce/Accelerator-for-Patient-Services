...
<Profile xmlns="http://soap.sforce.com/2006/04/metadata">
    <applicationVisibilities>
        <application>Patient_Services</application>
        <default>true</default>
        <visible>true</visible>
    </applicationVisibilities>
    <categoryGroupVisibilities>
        <dataCategoryGroup>General</dataCategoryGroup>
        <visibility>ALL</visibility>
    </categoryGroupVisibilities>
    <custom>true</custom>
    <layoutAssignments>
        <layout>Case-Clinical</layout>
        <recordType>Case.Clinical</recordType>
    </layoutAssignments>
    <layoutAssignments>
        <layout>Case-General</layout>
        <recordType>Case.General</recordType>
    </layoutAssignments>
    <layoutAssignments>
        <layout>Case-Scheduling</layout>
        <recordType>Case.Scheduling</recordType>
    </layoutAssignments>
    <layoutAssignments>
        <layout>PersonAccount-Patient Layout - Contact Center</layout>
        <recordType>PersonAccount.PersonAccount</recordType>
    </layoutAssignments>
    <layoutAssignments>
        <layout>Task-Task Layout - Contact Center</layout>
    </layoutAssignments>
    <layoutAssignments>
        <layout>Task-Task Layout - Contact Center</layout>
        <recordType>Task.Clinical</recordType>
    </layoutAssignments>
    <layoutAssignments>
        <layout>Task-Task Layout - Contact Center</layout>
    ...
    <layoutAssignments>
        <layout>Task-Task Layout - Contact Center</layout>
        <recordType>Task.Scheduling</recordType>
    </layoutAssignments>
    <layoutAssignments>
        <layout>Task-Task Layout - Contact Center</layout>
